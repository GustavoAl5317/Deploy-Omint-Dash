...
// Função para calcular as somas e criar o gráfico de pizza para os Associados
async function createChart() {
    ...
    const myChart = new Chart(ctx, {
        ...
        options: {
            plugins: {
                title: {
                    display: true,
                    text: 'Comparação entre Talktime, Holdtime e Ringtime - Associados'
                }
            },
            tooltips: {
                callbacks: {
    ...
    setInterval(updateChart, 5000); // Atualiza a cada 2 segundos
}
