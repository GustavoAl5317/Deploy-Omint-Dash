function update() {
    fetch('http://10.175.15.27:3000/firstCallMon')
    ...
    .then(data => {
        if (data && data.length > 0) {
            ...
            document.getElementById('classNameId-FirstCall-monthly').innerText = percentNoRechamadas + '%';

            // Atualiza o elemento HTML com a porcentagem de chamadas realizadas 2 vezes ou mais
            document.getElementById('classNameId-Rechamada-monthly').innerText = percentRechamadas + '%';
        } else {
