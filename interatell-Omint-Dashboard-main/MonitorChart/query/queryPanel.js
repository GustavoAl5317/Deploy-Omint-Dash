...
// export default async function queryPanelMonth() {
//   let connection;
...
//        , day((extend(today) + interval(3) hour to hour)) as total_days
...
//        GROUP BY csqname, datetime, disposition, id, timetoaband, notaccountable) AS subquery 
//      GROUP BY csqname, total_days) AS outerquery
     
//  ;
 
//  select distinct
//    sessionid
//    , min(startdatetime) as stardtatetime
//    , today as today
//    , month(today) as month
//    , today - day(today) + 1 as test
//    , day(today) as day
   
//    from contactcalldetail as ccd
   
//    where ccd.startdatetime >= today
   
//    group by sessionid
   
//  ;
//  select * from contactcalldetail as ccd where ccd.sessionid = 31000491092;`);
